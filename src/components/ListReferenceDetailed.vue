<template>
  <div class="list-reference">
    <img v-if="reference.urlToImage && !hideIcon" :src="reference.urlToImage" class="avatar square" :title="source && source.name" referrerpolicy="no-referrer" />
    <div v-if="!reference.urlToImage && !hideIcon" class="avatar" :title="source && source.name">

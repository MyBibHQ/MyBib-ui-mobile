<template>
  <div class="project-folder" :class="{hovering: isHoveringOver}">
    <div class="project-folder-btn" @click="toggleFolderState" @contextmenu.prevent="toggleContextMenu" draggable="true" @dragstart="onDragStart" @dragover="onDragOver" @dragleave="onDragLeave" @drop="onDrop">
...
<style lang="scss" scoped>
  ...
  .project-folder { padding: 3px 0; position:relative;
    .project-folder-btn { align-items: center; background:#ffffff; border-left:4px solid $secondary-color; border-radius:0 30px 30px 0; box-shadow:0 1px 2px rgba(0,0,0,0.2); cursor:pointer; display:flex; height:53px; padding:0 16px; width:100%;
